...
- ##### 分析项目结构
  ...
  - build.gradle:使用groovy语言编写
    ...
    - 依赖关键词对比：
      ...
      - 旧版本：2.x的依赖关键词
      - ![img](file:///D:/mytools/blogproject/image/2_x.png?lastModify=1571987164)
      - 新版本：3.x的依赖关键词
      - ![3_x](D:\mytools\blogproject\image\3_x.png)
...
- 设置属性值
  ...
  - 其他属性：
    - ![img](file:///D:/mytools/blogproject/image/using_attr.png?lastModify=1572245152)
  - 固定值布尔属性：
    - xhtml/html：`<input type="checkbox" checked="checked">or<input type="checkbox" checked />`
    - thymeleaf：`<input type th:checked="${user.active}" />`
    - ![using_control](D:\mytools\blogproject\image\using_control.png)
  - ​
...
- 迭代器
  ...
  - 基本的迭代：th:each
    ...
    - ![using_status](D:\mytools\blogproject\image\using_status.png)
  - ​
...
- 条件语句
  ...
  - th:switch：![using_switch](D:\mytools\blogproject\image\using_switch.png)
...
- 模板布局
  ...
  - ![using_thymeleaf_fragment](D:\mytools\blogproject\image\using_thymeleaf_fragment.png)
  - ![using_thymeleaf_fragment](D:\mytools\blogproject\image\using_thymeleaf_fragment2.png)

- 属性优先级

  - 当在同一个标签中写入多个th:*属性时，会发生什么？
  - `<li th:each="item : ${items}" th:text="${item.description}">Item description here</li>`
  - ![using_th_order](D:\mytools\blogproject\image\using_th_order.png)
  - ​
...
- 基本对象
  ...
  - ![using_context](D:\mytools\blogproject\image\using_context.png)
  ...
  - request/session属性
    ...
    - ![using_context_parm](D:\mytools\blogproject\image\using_context_parm.png)
    ...
    - Web上下文对象
      ...
      - ![using_context_web](D:\mytools\blogproject\image\using_context_web.png)
...
![using_project_thymeleaf_api](D:\mytools\blogproject\image\using_project_thymeleaf_api.png)
